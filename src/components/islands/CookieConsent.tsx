          ...
          <div className="cookie-banner__content">
            <div className="cookie-banner__text">
              ...
              <p className="cookie-banner__description">
                ...
                Jouw privacy is belangrijk voor mij — data wordt opgeslagen in de EU volgens
                GDPR-richtlijnen.
              </p>
            </div>
          ...
          <div className="cookie-modal__content">
            ...
            <div className="cookie-modal__preferences">
              ...
              <div className="preference-item">
                ...
                <p className="preference-item__description">
                  Helpt mij begrijpen hoe bezoekers de website gebruiken via Vercel Analytics. Data
                  wordt opgeslagen in de EU.
                </p>
              </div>
